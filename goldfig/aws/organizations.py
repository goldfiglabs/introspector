...
from goldfig.aws import load_boto_session, walk_graph, account_paths_for_import
from goldfig.aws.fetch import Proxy
from goldfig.aws.svc import GlobalService, GlobalResourceSpec, GlobalPoolImportFn, GlobalDbImportFn
...
def _import_graph(
    ...
    account_credentials: List[ProviderCredential]) -> List[f.Future]:
