...
WITH cte_resourceattrs AS (
    ...
    WHERE
        resource.provider_type = 'InstanceProfile'
...
SELECT DISTINCT
    ...
    (_clsc_3.attr_value #>> '{}') AS "instanceprofileid",
    (_clsc_4.attr_value #>> '{}') AS "instanceprofilename",
...
FROM ( SELECT DISTINCT
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_3 ON _clsc_3.uri = _key.uri
        ...
        AND _clsc_3.attr_name = 'instanceprofileid'
    LEFT JOIN cte_resourceattrs AS _clsc_4 ON _clsc_4.uri = _key.uri
        ...
        AND _clsc_4.attr_name = 'instanceprofilename'
...
COMMENT ON MATERIALIZED VIEW aws_iam_instanceprofile IS 'AWS IAM instance profiles and their associated attributes.'
