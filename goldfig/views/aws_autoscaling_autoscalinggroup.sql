DROP MATERIALIZED VIEW IF EXISTS aws_autoscaling_autoscalinggroup CASCADE;

CREATE MATERIALIZED VIEW aws_autoscaling_autoscalinggroup AS
SELECT
  R.id AS resource_id,
  R.uri,
...
REFRESH MATERIALIZED VIEW aws_autoscaling_autoscalinggroup;

COMMENT ON MATERIALIZED VIEW aws_autoscaling_autoscalinggroup IS 'autoscaling AutoScalingGroup resources and their associated attributes.';
