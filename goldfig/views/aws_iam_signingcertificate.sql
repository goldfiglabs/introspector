...
WITH cte_resourceattrs AS (
    ...
    WHERE
        resource.provider_type = 'SigningCertificate'
...
SELECT DISTINCT
    ...
    (_clsc_1.attr_value #>> '{}') AS "certificatebody",
    (_clsc_2.attr_value #>> '{}') AS "certificateid",
    (_clsc_3.attr_value #>> '{}') AS "status",
    (TO_TIMESTAMP(_clsc_4.attr_value #>> '{}', 'YYYY-MM-DD"T"HH24:MI:SS')::timestamp at time zone '00:00') AS "uploaddate",
    (_clsc_5.attr_value #>> '{}') AS "username"
FROM ( SELECT DISTINCT
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_1 ON _clsc_1.uri = _key.uri
        ...
        AND _clsc_1.attr_name = 'certificatebody'
    LEFT JOIN cte_resourceattrs AS _clsc_2 ON _clsc_2.uri = _key.uri
        ...
        AND _clsc_2.attr_name = 'certificateid'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_4 ON _clsc_4.uri = _key.uri
        ...
        AND _clsc_4.attr_name = 'uploaddate'
    LEFT JOIN cte_resourceattrs AS _clsc_5 ON _clsc_5.uri = _key.uri
        ...
        AND _clsc_5.attr_name = 'username' WITH NO DATA;

REFRESH MATERIALIZED VIEW aws_iam_signingcertificate;

COMMENT ON MATERIALIZED VIEW aws_iam_signingcertificate IS 'AWS IAM signing certificates and their associated attributes.'
