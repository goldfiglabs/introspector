DROP MATERIALIZED VIEW IF EXISTS aws_ec2_vpcpeeringconnection CASCADE;

CREATE MATERIALIZED VIEW aws_ec2_vpcpeeringconnection AS
SELECT
  R.id AS resource_id,
  R.uri,
...
REFRESH MATERIALIZED VIEW aws_ec2_vpcpeeringconnection;

COMMENT ON MATERIALIZED VIEW aws_ec2_vpcpeeringconnection IS 'ec2 VpcPeeringConnection resources and their associated attributes.';
