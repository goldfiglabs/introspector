DROP MATERIALIZED VIEW IF EXISTS aws_ses_identity CASCADE;

CREATE MATERIALIZED VIEW aws_ses_identity AS
SELECT
  R.id AS resource_id,
  R.uri,
...
REFRESH MATERIALIZED VIEW aws_ses_identity;

COMMENT ON MATERIALIZED VIEW aws_ses_identity IS 'ses Identity resources and their associated attributes.';
