DROP MATERIALIZED VIEW IF EXISTS aws_rds_dbclustersnapshot CASCADE;

CREATE MATERIALIZED VIEW aws_rds_dbclustersnapshot AS
SELECT
  R.id AS resource_id,
  R.uri,
...
REFRESH MATERIALIZED VIEW aws_rds_dbclustersnapshot;

COMMENT ON MATERIALIZED VIEW aws_rds_dbclustersnapshot IS 'rds DBClusterSnapshot resources and their associated attributes.';
