DROP MATERIALIZED VIEW IF EXISTS aws_ec2_address CASCADE;

CREATE MATERIALIZED VIEW aws_ec2_address AS
SELECT
  R.id AS resource_id,
  R.uri,
...
REFRESH MATERIALIZED VIEW aws_ec2_address;

COMMENT ON MATERIALIZED VIEW aws_ec2_address IS 'ec2 Address resources and their associated attributes.';
