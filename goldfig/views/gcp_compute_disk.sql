DROP MATERIALIZED VIEW IF EXISTS gcp_compute_disk CASCADE;

CREATE MATERIALIZED VIEW gcp_compute_disk AS
...
SELECT DISTINCT
    ...
    (TO_TIMESTAMP(_clsc_1.attr_value #>> '{}', 'YYYY-MM-DD"T"HH24:MI:SS')::timestamp at time zone '00:00') AS "creationtimestamp",
    (_clsc_2.attr_value #>> '{}') AS "description",
    (_clsc_3.attr_value::jsonb) AS "diskencryptionkey",
    (_clsc_5.attr_value::jsonb) AS "guestosfeatures",
    (_clsc_6.attr_value #>> '{}')::bigint AS "id",
    (_clsc_7.attr_value #>> '{}') AS "kind",
    (_clsc_8.attr_value #>> '{}') AS "labelfingerprint",
    (_clsc_9.attr_value::jsonb) AS "labels",
    (TO_TIMESTAMP(_clsc_10.attr_value #>> '{}', 'YYYY-MM-DD"T"HH24:MI:SS')::timestamp at time zone '00:00') AS "lastattachtimestamp",
    (TO_TIMESTAMP(_clsc_11.attr_value #>> '{}', 'YYYY-MM-DD"T"HH24:MI:SS')::timestamp at time zone '00:00') AS "lastdetachtimestamp",
    (_clsc_12.attr_value::jsonb) AS "licensecodes",
    (_clsc_13.attr_value::jsonb) AS "licenses",
    (_clsc_14.attr_value #>> '{}') AS "name",
    (_clsc_15.attr_value #>> '{}') AS "options",
    (_clsc_16.attr_value #>> '{}')::bigint AS "physicalblocksizebytes",
    (_clsc_18.attr_value::jsonb) AS "replicazones",
    (_clsc_19.attr_value::jsonb) AS "resourcepolicies",
    (_clsc_20.attr_value #>> '{}') AS "selflink",
    (_clsc_22.attr_value #>> '{}')::integer AS "sizegb",
    (_clsc_23.attr_value #>> '{}') AS "sourceimage",
    (_clsc_24.attr_value #>> '{}') AS "sourceimageencryptionkey",
    (_clsc_25.attr_value #>> '{}') AS "sourceimageid",
    (_clsc_26.attr_value #>> '{}') AS "sourcesnapshot",
    (_clsc_27.attr_value::jsonb) AS "sourcesnapshotencryptionkey",
    (_clsc_28.attr_value #>> '{}') AS "sourcesnapshotid",
    (_clsc_29.attr_value #>> '{}') AS "status",
    (_clsc_31.attr_value #>> '{}') AS "type",
    (_clsc_32.attr_value::jsonb) AS "users"
FROM ( SELECT DISTINCT
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_1 ON _clsc_1.uri = _key.uri
        ...
        AND _clsc_1.attr_name = 'creationtimestamp'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_3 ON _clsc_3.uri = _key.uri
        ...
        AND _clsc_3.attr_name = 'diskencryptionkey'
    LEFT JOIN cte_resourceattrs AS _clsc_4 ON _clsc_4.uri = _key.uri
        ...
        AND _clsc_4.attr_name = 'encrypted'
    LEFT JOIN cte_resourceattrs AS _clsc_5 ON _clsc_5.uri = _key.uri
        ...
        AND _clsc_5.attr_name = 'guestosfeatures'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_8 ON _clsc_8.uri = _key.uri
        ...
        AND _clsc_8.attr_name = 'labelfingerprint'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_10 ON _clsc_10.uri = _key.uri
        ...
        AND _clsc_10.attr_name = 'lastattachtimestamp'
    LEFT JOIN cte_resourceattrs AS _clsc_11 ON _clsc_11.uri = _key.uri
        ...
        AND _clsc_11.attr_name = 'lastdetachtimestamp'
    LEFT JOIN cte_resourceattrs AS _clsc_12 ON _clsc_12.uri = _key.uri
        ...
        AND _clsc_12.attr_name = 'licensecodes'
    LEFT JOIN cte_resourceattrs AS _clsc_13 ON _clsc_13.uri = _key.uri
        ...
        AND _clsc_13.attr_name = 'licenses'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_15 ON _clsc_15.uri = _key.uri
        ...
        AND _clsc_15.attr_name = 'options'
    LEFT JOIN cte_resourceattrs AS _clsc_16 ON _clsc_16.uri = _key.uri
        ...
        AND _clsc_16.attr_name = 'physicalblocksizebytes'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_18 ON _clsc_18.uri = _key.uri
        ...
        AND _clsc_18.attr_name = 'replicazones'
    LEFT JOIN cte_resourceattrs AS _clsc_19 ON _clsc_19.uri = _key.uri
        ...
        AND _clsc_19.attr_name = 'resourcepolicies'
    LEFT JOIN cte_resourceattrs AS _clsc_20 ON _clsc_20.uri = _key.uri
        ...
        AND _clsc_20.attr_name = 'selflink'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_23 ON _clsc_23.uri = _key.uri
        ...
        AND _clsc_23.attr_name = 'sourceimage'
    LEFT JOIN cte_resourceattrs AS _clsc_24 ON _clsc_24.uri = _key.uri
        ...
        AND _clsc_24.attr_name = 'sourceimageencryptionkey'
    LEFT JOIN cte_resourceattrs AS _clsc_25 ON _clsc_25.uri = _key.uri
        ...
        AND _clsc_25.attr_name = 'sourceimageid'
    LEFT JOIN cte_resourceattrs AS _clsc_26 ON _clsc_26.uri = _key.uri
        ...
        AND _clsc_26.attr_name = 'sourcesnapshot'
    LEFT JOIN cte_resourceattrs AS _clsc_27 ON _clsc_27.uri = _key.uri
        ...
        AND _clsc_27.attr_name = 'sourcesnapshotencryptionkey'
    LEFT JOIN cte_resourceattrs AS _clsc_28 ON _clsc_28.uri = _key.uri
        ...
        AND _clsc_28.attr_name = 'sourcesnapshotid'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_33 ON _clsc_33.uri = _key.uri
        ...
        AND _clsc_33.attr_name = 'zone' WITH NO DATA;

REFRESH MATERIALIZED VIEW gcp_compute_disk;

COMMENT ON MATERIALIZED VIEW gcp_compute_disk IS 'GCP compute disk resources and their associated attributes.';
