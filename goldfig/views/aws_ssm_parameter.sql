DROP MATERIALIZED VIEW IF EXISTS aws_ssm_parameter CASCADE;

CREATE MATERIALIZED VIEW aws_ssm_parameter AS
SELECT
  R.id AS resource_id,
  R.uri,
...
REFRESH MATERIALIZED VIEW aws_ssm_parameter;

COMMENT ON MATERIALIZED VIEW aws_ssm_parameter IS 'ssm Parameter resources and their associated attributes.';
