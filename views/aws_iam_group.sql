...
SELECT DISTINCT
    ...
    (TO_TIMESTAMP(_clsc_2.attr_value #>> '{}', 'YYYY-MM-DD"T"HH24:MI:SS')::timestamp at time zone '00:00') AS "createdate",
    (_clsc_3.attr_value #>> '{}') AS "groupid",
    (_clsc_4.attr_value #>> '{}') AS "groupname",
    (_clsc_5.attr_value #>> '{}') AS "path"
FROM ( SELECT DISTINCT
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_2 ON _clsc_2.uri = _key.uri
        ...
        AND _clsc_2.attr_name = 'createdate'
    ...
    LEFT JOIN cte_resourceattrs AS _clsc_4 ON _clsc_4.uri = _key.uri
        ...
        AND _clsc_4.attr_name = 'groupname'
    LEFT JOIN cte_resourceattrs AS _clsc_5 ON _clsc_5.uri = _key.uri
        ...
        AND _clsc_5.attr_name = 'path' WITH NO DATA;

REFRESH MATERIALIZED VIEW aws_iam_group;

COMMENT ON MATERIALIZED VIEW aws_iam_group IS 'AWS IAM groups and their associated attributes.'
