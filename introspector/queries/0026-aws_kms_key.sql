...
FROM
  ...
  LEFT JOIN resource_attribute AS awsaccountid
    ...
    AND awsaccountid.provider_account_id = R.provider_account_id
  ...
  LEFT JOIN resource_attribute AS keyusage
    ...
    AND keyusage.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS keystate
    ...
    AND keystate.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS deletiondate
    ...
    AND deletiondate.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS validto
    ...
    AND validto.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS origin
    ...
    AND origin.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS customkeystoreid
    ...
    AND customkeystoreid.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS cloudhsmclusterid
    ...
    AND cloudhsmclusterid.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS expirationmodel
    ...
    AND expirationmodel.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS keymanager
    ...
    AND keymanager.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS customermasterkeyspec
    ...
    AND customermasterkeyspec.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS encryptionalgorithms
    ...
    AND encryptionalgorithms.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS signingalgorithms
    ...
    AND signingalgorithms.provider_account_id = R.provider_account_id
  ...
  LEFT JOIN resource_attribute AS keyrotationenabled
    ...
    AND keyrotationenabled.provider_account_id = R.provider_account_id
