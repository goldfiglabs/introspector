...
FROM
  ...
  LEFT JOIN resource_attribute AS associations
    ...
    AND associations.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS propagatingvgws
    ...
    AND propagatingvgws.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS routetableid
    ...
    AND routetableid.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS routes
    ...
    AND routes.provider_account_id = R.provider_account_id
