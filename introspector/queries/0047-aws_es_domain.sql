...
FROM
  ...
  LEFT JOIN resource_attribute AS domainid
    ...
    AND domainid.provider_account_id = R.provider_account_id
  ...
  LEFT JOIN resource_attribute AS created
    ...
    AND created.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS deleted
    ...
    AND deleted.provider_account_id = R.provider_account_id
  ...
  LEFT JOIN resource_attribute AS endpoints
    ...
    AND endpoints.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS processing
    ...
    AND processing.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS upgradeprocessing
    ...
    AND upgradeprocessing.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS elasticsearchversion
    ...
    AND elasticsearchversion.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS elasticsearchclusterconfig
    ...
    AND elasticsearchclusterconfig.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS ebsoptions
    ...
    AND ebsoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS accesspolicies
    ...
    AND accesspolicies.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS snapshotoptions
    ...
    AND snapshotoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS vpcoptions
    ...
    AND vpcoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS cognitooptions
    ...
    AND cognitooptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS encryptionatrestoptions
    ...
    AND encryptionatrestoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS nodetonodeencryptionoptions
    ...
    AND nodetonodeencryptionoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS advancedoptions
    ...
    AND advancedoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS logpublishingoptions
    ...
    AND logpublishingoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS servicesoftwareoptions
    ...
    AND servicesoftwareoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS domainendpointoptions
    ...
    AND domainendpointoptions.provider_account_id = R.provider_account_id
  LEFT JOIN resource_attribute AS advancedsecurityoptions
    ...
    AND advancedsecurityoptions.provider_account_id = R.provider_account_id
