...
SELECT
  ...
  attrs.provider ->> 'CertificateId' AS certificateid,
  attrs.provider ->> 'CertificateBody' AS certificatebody,
  attrs.provider ->> 'Status' AS status,
  (TO_TIMESTAMP(attrs.provider ->> 'UploadDate', 'YYYY-MM-DD"T"HH24:MI:SS')::timestamp at time zone '00:00') AS uploaddate,
